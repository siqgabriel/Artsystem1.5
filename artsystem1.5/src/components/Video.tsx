...
export function Video({ videoId }: Readonly<VideoProps>) {
  ...
  return (
    <section className="w-full">
      <Container>
        <div className="relative w-full h-[500px] max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl bg-red-300 cursor-pointer bg-gradient-to-tr from-rose-400 to-custom1">
          {!playVideo && (
            <button
